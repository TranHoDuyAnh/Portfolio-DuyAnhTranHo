...
export const skillCategories: SkillCategory[] = [
  {
    ...
    skills: [
      { name: "React.js / Next.js (App Router 15/16)", level: "Advanced", highlight: true, projects: ["CreatorOS", "AdaptiveLMS", "Tiệm Người Quảng", "Shi-Perfume", "Moonbean Coffee", "Nha Khoa Tâm Anh", "Luméa Spa"] },
      { name: "React 19 & Material-UI (MUI v7)", level: "Advanced", highlight: true, projects: ["EV Battery Swap", "Nha Khoa Tâm Anh", "Luméa Spa"] },
      ...
      { name: "TypeScript (Strict) & JavaScript (ES6+)", level: "Advanced", highlight: true, projects: ["CreatorOS", "Pulse", "AdaptiveLMS", "Tiệm Người Quảng", "Shi-Perfume", "EV Battery Swap", "Moonbean Coffee", "Nha Khoa Tâm Anh", "Luméa Spa"] },
      { name: "HTML5 / CSS3 / Tailwind CSS v4", level: "Advanced", highlight: true, projects: ["CreatorOS", "AdaptiveLMS", "Tiệm Người Quảng", "Pulse", "Shi-Perfume", "Moonbean Coffee", "Nha Khoa Tâm Anh", "Luméa Spa"] },
      { name: "Vue.js & Angular", level: "Proficient", projects: ["FPT Software"] },
      { name: "React Native (Foundation)", level: "Proficient", projects: ["Pulse"] },
      { name: "Mobile-First & UI/UX Optimization", level: "Advanced", highlight: true, projects: ["CreatorOS", "Pulse", "Tiệm Người Quảng", "Shi-Perfume", "EV Battery Swap", "Moonbean Coffee", "Nha Khoa Tâm Anh", "Luméa Spa"] },
      { name: "Performance Tuning & Core Web Vitals", level: "Advanced", projects: ["CreatorOS", "Tiệm Người Quảng", "Shi-Perfume", "Moonbean Coffee"] },
    ],
  },
  {
    title: {
    ...
    skills: [
      ...
      { name: "Next.js Server Actions & REST APIs", level: "Advanced", highlight: true, projects: ["CreatorOS", "Tiệm Người Quảng", "Shi-Perfume", "EV Battery Swap", "Moonbean Coffee", "Nha Khoa Tâm Anh", "Luméa Spa"] },
      { name: "SignalR (Real-Time WebSockets)", level: "Proficient", projects: ["Pulse"] },
      { name: "Python / FastAPI", level: "Proficient", projects: ["Pulse"] },
      { name: "JWT & Role-Based Access Control (RBAC)", level: "Core", projects: ["CreatorOS", "AdaptiveLMS", "Pulse", "Shi-Perfume", "EV Battery Swap", "Moonbean Coffee", "Nha Khoa Tâm Anh", "Luméa Spa"] },
    ],
  },
  {
    title: {
    ...
    skills: [
      ...
      { name: "PostgreSQL (GIN Full-Text Search)", level: "Advanced", highlight: true, projects: ["CreatorOS", "Pulse", "AdaptiveLMS", "Tiệm Người Quảng", "Shi-Perfume", "Moonbean Coffee", "Nha Khoa Tâm Anh", "Luméa Spa"] },
      { name: "Prisma ORM 5 & 6", level: "Advanced", highlight: true, projects: ["CreatorOS", "AdaptiveLMS", "Moonbean Coffee", "Nha Khoa Tâm Anh", "Luméa Spa"] },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Docker & Docker Compose", level: "Advanced", highlight: true, projects: ["Pulse", "AdaptiveLMS", "Moonbean Coffee", "Nha Khoa Tâm Anh", "Luméa Spa"] },
      { name: "Vitest, Jest & Agile/Scrum", level: "Proficient", projects: ["CreatorOS", "AdaptiveLMS", "FPT Software"] },
      { name: "Zod Schema Validation & Zustand", level: "Advanced", highlight: true, projects: ["CreatorOS", "Tiệm Người Quảng", "AdaptiveLMS", "Shi-Perfume", "Nha Khoa Tâm Anh", "Luméa Spa"] },
    ],
  },
];
